...
<head>
    ...
    <style type="text/css">
        @font-face {
            ...
            src: url('/northwind/fonts/glyphicons-halflings-regular.eot');
            src: url('/northwind/fonts/glyphicons-halflings-regular.eot?#iefix') format('embedded- opentype'), url('/northwind/fonts/glyphicons-halflings-regular.woff') format('woff'), url('/northwind/fonts/glyphicons-halflings-regular.ttf') format('truetype'), url('/northwind/fonts/glyphicons-halflings-regular.svg#glyphicons-halflingsregular') format('svg');
        }
    </style>
